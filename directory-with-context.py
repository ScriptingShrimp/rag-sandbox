...
question = 'In the provided bash scripts, I need to modify them to utilize sail operator setup instead of the current setup. Can you provide me with the necessary changes to the scripts?'
